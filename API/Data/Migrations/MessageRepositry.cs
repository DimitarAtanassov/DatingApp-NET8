...
public class MessageRepositry(DataContext context, IMapper mapper) : IMessageRepository
{
    ...
    public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
    {
        ...
        query = messageParams.Container switch
        {
            ...
            _ => query.Where(x => x.Recipient.UserName == messageParams.Username && x.DateRead == null && x.RecipientDeleted == false) // Default (For "Unread" messages)
        };
